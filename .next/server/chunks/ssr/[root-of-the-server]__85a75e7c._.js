...
async function signUp(email, password, userData) {
    try {
        ...
        if (authData.user) {
            const { data: profileData, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("users").insert([
                {
            ...
            if (profileError) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.admin.deleteUser(authData.user.id);
                return {
                    data: null,
                    error: profileError
                };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2d$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/supabase-client.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function SignUp() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2d$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signUp"])(formData.email, formData.password, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85a75e7c._.js.map